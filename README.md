EE Wait Lists Add-on
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-wait-lists.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-wait-lists/releases)
[![Travis](https://travis-ci.org/eventespresso/eea-wait-lists.svg?branch=master)](https://travis-ci.org/eventespresso/eea-wait-lists)
...
[![Minimum EE Core Version:](https://img.shields.io/badge/Minimum%20EE%20core%20ver-4.9.18.p-red.svg)](https://github.com/eventespresso/event-espresso-core/releases/tag/4.9.18.p)

The Wait Lists add-on for [Event Espresso](https://github.com/eventespresso/event-espresso-core) adds functionality for managing and setting up wait-lists for your events.
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/eea-wait-lists?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/eea-wait-lists?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
...
> We ask if you are using this to provide a solution for clients that you (or your client) [purchase a support license](https://eventespresso.com/product/eea-wait-lists?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license) for this add-on.
