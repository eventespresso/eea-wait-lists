...
$I->amGoingTo('Edit "Event Wait List Test" from previous test and open up 2 more available spots.');
$I->loginAsAdmin();
...
$I->amGoingTo('Verify that 2 Wait List Promotion messages were sent out.');
