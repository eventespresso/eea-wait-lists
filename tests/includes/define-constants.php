...
define( 'EE_PLUGIN_DIR', dirname( dirname( dirname( __DIR__ ) ) ) . '/event-espresso-core/');
define( 'EE_WAITLISTS_TEST_DIR', dirname( __DIR__ ) . '/'  );
define( 'EE_WAITLISTS_PLUGIN_DIR' , dirname( dirname( __DIR__  ) ). '/' );
